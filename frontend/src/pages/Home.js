...
const FEATURE_LIST = [
  ...
  },
  {
    ...
    subTitle: 'Luyện nghe, nói câu tiếng Anh giao tiếp hàng ngày cùng VOCA',
  ...
  },
  {
    ...
    subTitle:
      'Flashcard phương pháp học từ vựng nổi tiếng. Nay hoàn toàn miễn phí trên VOCA',
    imgUrl: flashcardIcon,
    to: ROUTES.FLASHCARD,
  },
  {
    title: 'Từ điển trong VOCA',
  ...
  },
  {
    ...
    imgUrl: gameIcon,
    subTitle:
      'Ôn luyện kiến thức hiệu quả và đỡ nhàm chán hơn qua việc chơi game cùng VOCA nhé',
  ...
  },
  {
    ...
    imgUrl: editIcon,
    subTitle:
      'VOCA mong được sự đóng góp của bạn. Bạn có thể thêm từ mới, sửa lỗi sai',
    to: ROUTES.CONTRIBUTION,
  },
];

function HomePage() {
  useTitle('VOCA - Ứng dụng học tiếng Anh miễn phí');
  useScrollTop();
